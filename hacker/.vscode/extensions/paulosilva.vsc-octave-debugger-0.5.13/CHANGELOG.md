...
## 0.4.9
* Fix issue [#40](https://github.com/paulo-fernando-silva/vscOctaveDebugger/issues/40), i.e. now the plugin works with octave >5.1. Though pause() and kbhit() are still issues.

## 0.4.8
* Fix for issue [#37](https://github.com/paulo-fernando-silva/vscOctaveDebugger/issues/37) gave origin to issue [#38](https://github.com/paulo-fernando-silva/vscOctaveDebugger/issues/38), hopefully, this fixes it. ^^

## 0.4.7
* Fixed issue [#37](https://github.com/paulo-fernando-silva/vscOctaveDebugger/issues/37), escaped paths.
...
## 0.4.3
* Fix remove_all_breakpoint_in_file: unable to find function ex1 [#33](https://github.com/paulo-fernando-silva/vscOctaveDebugger/issues/33)
...
* Fixes issue [#25](https://github.com/paulo-fernando-silva/vscOctaveDebugger/issues/25) basename fails when path is not a path, but includes a path-like structure.
...
## 0.1.6
* Fix for issue [#7](https://github.com/paulo-fernando-silva/vscOctaveDebugger/issues/7) "scope list children fails when answer contains new lines"
