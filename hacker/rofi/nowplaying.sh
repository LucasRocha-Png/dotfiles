...
# --- Configuration ---
art_file="$HOME/dotfiles/hacker/rofi/nowplaying/album_art.png"
fallback_art_file="$HOME/dotfiles/hacker/rofi/nowplaying/fallback_album_art.png"
rofi_theme="$HOME/dotfiles/hacker/rofi/nowplaying/nowplaying.rasi"
cache_file="$HOME/dotfiles/hacker/rofi/nowplaying/song_title.cache"
